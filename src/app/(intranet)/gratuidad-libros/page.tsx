...
export default async function GratuidadLibrosPage() {
  ...
  const [
    ...
    supabase
      ...
      .select("id, libro_id, alumno_id, alumno_nombre, alumno_grupo, num_ejemplar, fecha_prestamo, entregado_por, devuelto_por, revisado_por, curso_escolar, fecha_devolucion, devolucion_registrada_at, estado_devolucion, observaciones, created_at, en_revision, estado_revision, fecha_revision, libro:libros_catalogo(titulo, asignatura, nivel)")
